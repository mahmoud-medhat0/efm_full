...
const DashboardLayout = ({ children }: { children: React.ReactNode }) => {
    ...
    useEffect(() => {
        if (!user.has_active_subscription) {
            if (route().current()?.startsWith("client.dashboard")) {
                if (
                    route().current() !== "client.dashboard.membership" &&
                    route().current() !== "client.dashboard.deposit" &&
                    route().current() !== "client.dashboard.membership"
                ) {
                    toast.error(
                        "You need to upgrade your account to access this page",
                        {
                            duration: 5000,
                            position: "top-right",
                        }
                    ...
                    <div className="container">
                        {showModal && (
                            ...
                            >
                                ...
                                <p className="mb-4">
                                    You need to upgrade your account to access
                                    this page.
                                </p>
