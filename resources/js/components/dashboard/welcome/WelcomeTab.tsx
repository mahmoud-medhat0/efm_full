      ...
      <div className="w-[300px]">
        <div className="flex flex-row justify-between items-center">
          ...
          <div className="flex flex-col">
            <h2 className="text-black text-2xl">Welcome, {user.name}!</h2>
            <h4 className="text-black text-lg">
              You Membership <span className="text-primary">Bronze</span>.
            </h4>
          </div>
        </div>
        <div className="ml-[90px] mt-5">
          ...
          >
            <ArrowUpCircleIcon className="text-primary w-6 h-6" /> Upgrade Account
          </Link>
          <div>
            <h3 className="flex flex-row items-center gap-2 mb-1">
              <LinkIcon className="text-primary w-6 h-6" /> Your referral link:
            </h3>
            <input
              disabled
