...
<head>
    ...
    <link rel="stylesheet" href="{{ env('APP_URL') }}/invoiceassets/css/Invoice.css">
</head>
<body>
    <header class="header">
        <div class="top-bar">
    ...
    <main class="main-content">
        <div class="invoice-header">
            <div class="logo-section">
                <img src="{{ env('APP_URL') }}/invoiceassets/photo/Group.svg" alt="EFM Logo" class="logo">
                <img src="{{ env('APP_URL') }}/invoiceassets/photo/line2.svg" alt="EFM Logo" class="line2" />
                <div class="titel3">
                    <h2>EFM</h2>
                    <p>Earn Free Money</p>
            ...
            <div class="invoice-title">
                ...
                <h1>فاتورة معاملة
                    ...
                    <img src="{{ env('APP_URL') }}/invoiceassets/photo/line1.svg" alt="EFM Logo" class="line1" />
            </div>
    ...
    <footer class="footer">
        <div class="footer-container">
            <div class="footer-item">
                <img src="{{ env('APP_URL') }}/invoiceassets/photo/Group (2).svg" alt="EFM Logo" />
            ...
            <div class="footer-item">
                ...
                <p><img src="{{ env('APP_URL') }}/invoiceassets/photo/phone.svg" alt="Email Icon" style="width: 16px; height:16px; "><a href="mailto:support@efmhub.com" style="color: inherit; text-decoration: none;">support@efmhub.com</a>
                </p>
                <p><img src="{{ env('APP_URL') }}/invoiceassets/photo/Email.svg" alt="Phone Icon" style="width: 16px; height:16px; "><a href="tel:+20120655342" style="color: inherit; text-decoration: none;">+20120655342</a></p>
                <p><img src="{{ env('APP_URL') }}/invoiceassets/photo/Vector (4).svg" alt="Twitter Icon" style="width: 16px; height:16px; "><a href="https://t.me/EFM_Hub" target="_blank" style="color: inherit; text-decoration: none;">@EFM_Hub</a></p>
            </div>
        </div>
